export default function ApiExausted(argument) {
		...
		<div class="row align-items-center">
			...
			<div class="col-md-6 text-center text-md-start ">
				<div class="lc-block mb-3">
					<div editable="rich">
						<h1 class="fw-bold h4">API QUOTA FINISHED!<br/></h1>
					</div>
				</div>
				<div class="lc-block mb-3">
					<div editable="rich">
				...
				<div class="lc-block mb-5">
					<div editable="rich">
						<p class="rfs-11 fw-light"> your daily api quota has finished .try tommorow</p>
					</div>
				</div>
				<div class="lc-block">
