...
export default function BharathNatyam(argument) {
 ...
 <section id="hero">
      <div class="wrapper" id="history-content">
        ...
        <div class="photographer"><img src={require("../assets/img/barathnatya.jpg")} alt="Photographer"/></div>
      </div>
    </section>
    <section id="about">
      <div class="wrapper">
        <div class="camera"><img src={require("../assets/img/barathnatya2.jpg")} alt="Camera"/></div>
        <div class="blurb">
          <h2><strong>HISTORY</strong></h2>
          <p>The theoretical foundations of Bharatanatyam are found first in Kootha Nool in Tamil and then referred also in Natya Shastra, a Sanskrit text of performance arts.

            Natya Shastra is attributed to the ancient scholar Bharata Muni, and its first complete compilation is dated to between 200 BCE and 200 CE, but estimates vary between 500 BCE and 500 CE. The most studied version of the Natya Shastra text consists of about 6000 verses structured into 36 chapters. The text, states Natalia Lidova, describes the theory of Tāṇḍava dance (Shiva), the theory of rasa, of bhāva, expression, gestures, acting techniques, basic steps, standing postures—all of which are part of Indian classical dances. Dance and performance arts, states this text, are a form of expression of spiritual ideas, virtues and the essence of scriptures</p>
      ...
      <div class="wrapper">
        <div class="blurb">
          ...
          <p><strong>Adavus</strong>
            The word Adavu comes from the Tamil root adu, meaning to dance. The Adavus are sets of basic dance steps which help a dancer master the foundation. Adavus will also refine a dancer's endurance, posture, mudras, dhristi bheda (eye movements), etc.
            </p>
          </div>
        <div class="featured"><img src={require("../assets/img/bharathanatyam[332].jpg")} alt="Featured"/></div>
      </div>
    </section>
    ...
    <section id="contact">
      <div class="wrapper">
        <div class="blurb">
          <h2><strong>LEARN</strong> more</h2>
         <p>
          The initial pre- historic period where references of dance in some form can be traced to ancient cave paintings, engravings, older civilisations, Vedic references in Upanishads, Puranas, Bramhana, epics etc. 
          The period starting from the 2nd century B.C. through 9th Century A.D., wherein we get references about dancing from the monuments of ancient dynasties, Buddhist stupas, caves of Ellora and temples in various parts of India from Kashmir to Kanyakumari. These temples contain sculptures of dancers of different dance forms.
          The most recent or the modern phase is the period covered from the 10th Century A.D. to the present time. This period witnessed the development and growth of this art to a great extent towards regional, architectural, sculptural, pictorial and musical fields. 
          ...
          The initial pre- historic period where references of dance in some form can be traced to ancient cave paintings, engravings, older civilisations, Vedic references in Upanishads, Puranas, Bramhana, epics etc.
          The period starting from the 2nd century B.C. through 9th Century A.D., wherein we get references about dancing from the monuments of ancient dynasties, Buddhist stupas, caves of Ellora and temples in various parts of India from Kashmir to Kanyakumari. These temples contain sculptures of dancers of different dance forms.
          The most recent or the modern phase is the period covered from the 10th Century A.D. to the present time. This period witnessed the development and growth of this art to a great extent towards regional, architectural, sculptural, pictorial and musical fields.</p>
