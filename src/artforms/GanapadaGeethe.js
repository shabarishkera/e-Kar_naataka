 ...
 <div class="container">
            ...
            <div class="col-lg-6 p-lg-6">
                <div class="lc-block mb-5">
                    <div editable="rich">
                        ...
                        <h2 class="display-6 fw-bold">JAANAPADA GEETHE</h2>

                        <p class="lead"><br/>Jaanapada is a word made by two words Jana - People or tribe Pada - a kind of short verse joined as a sandhi- a grammatical term. The folk culture and colloquial tongue of Kannadiga and probably Telugu people were known by this name from time the languages came into existence.
        ...
        <div class="row mb-4 align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0 order-lg-1">
                <div class="lc-block text-center">
                    <img class="img-fluid w-200" src="https://gostops.com/blog/wp-content/uploads/2017/07/folk-music-1.jpg" srcset="" sizes="" width="" height=""/>
            ...
            <div class="col-lg-6 p-lg-6">
                ...
                <div class="lc-block">
                    <div class="d-inline-flex">
                      ...
                      <p class="intro"> Karnataka Janapada Folk Tradition even though includes every aspect of Kannadiga life can be broadly classified into three main heads.</p>
